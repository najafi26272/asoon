...
(function () {
    ...
    const flatpickrDate = document.querySelector('#flatpickr-date'),
        flatepickerEditMosavabe=document.querySelector('#flatepicker-edit-mosavabe'),
        flatpickrEditTask=document.querySelector('#flatpickr-edit-task'),
        flatpickrTime = document.querySelector('#flatpickr-time'),
        flatpickrDateTime = document.querySelector('#flatpickr-datetime'),
        flatpickrDateTimeTaskChangeStatus = document.querySelector('flatpickr-datetime-task-change-status'),
        ...
        flatpickrProjectStart = document.querySelector('#flatpickr-project-start'),
        flatpickrProjectDeadline = document.querySelector('#flatpickr-project-deadline'),
        flatpickrTaskEnd = document.querySelector('#flatpickr-task-end');

    if(flatpickrTaskEnd){
        flatpickrTaskEnd.flatpickr({
            enableTime: false,
            locale: 'fa',
            altInput: true,
            altFormat: 'Y/m/d ',
    ...
    if(flatpickrProjectDeadline){
        flatpickrProjectDeadline.flatpickr({
            enableTime: false,
            locale: 'fa',
            altInput: true,
            altFormat: 'Y/m/d ',
 ...
 if(flatpickrProjectStart){
        flatpickrProjectStart.flatpickr({
            enableTime: false,
            locale: 'fa',
            altInput: true,
            altFormat: 'Y/m/d ',
    ...
    if(flatepickerEditMosavabe){
        flatepickerEditMosavabe.flatpickr({
            enableTime: true,
            locale: 'fa',
            altInput: true,
            altFormat: 'Y/m/d - H:i',
    ...
    if(flatpickrEditTask){
        flatpickrEditTask.flatpickr({
            enableTime: true,
            locale: 'fa',
            altInput: true,
            altFormat: 'Y/m/d - H:i',
    ...
    // Datetime
    if (flatpickrDateTimeTaskChangeStatus) {
      
        flatpickrDateTimeTaskChangeStatus.flatpickr({
            enableTime: true,
            locale: 'fa',
            altInput: true,
            altFormat: 'Y/m/d - H:i',
