...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
            ...
            <div wire:ignore.selfe class="d-flex flex-column mb-8">
                ...
                <select class="form-select form-select-solid" id="editSelectedProjectCategory"
                        ...
                        <option <?php if($selectedProjectCategory == $projectCategory->id ): ?> selected <?php endif; ?> value="<?php echo e($projectCategory->id); ?>"><?php echo e($projectCategory->title); ?></option>
                    ...
                    <div wire:ignore.selfe class="d-flex flex-column mb-8 fv-row">
                        ...
                        <select class="form-select form-select-solid" id="editSelectedManager"
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option <?php if($user->id == $selectedManager): ?> selected
                ...
                <div class="col-md-6 fv-row">
                    ...
                    <div wire:ignore.selfe class="d-flex flex-column mb-8 fv-row">
                        ...
                        <select class="form-select form-select-solid" id="editSelectedMembers"
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option <?php if(in_array($user->id, $selectedMembers)): ?> selected
                                        <?php endif; ?>  value="<?php echo e($user->id); ?>"> <?php echo e($user->name); ?> <?php echo e($user->family); ?></option>
            ...
            <div class="d-flex flex-column mb-8">
                <div class="mb-8 fv-row">
                    ...
                    <div wire:ignore class="position-relative d-flex align-items-center">
                        ...
                        <input wire:model="startDate" value="<?php echo e($startDate); ?>" type="text" class="form-control form-control-solid"
            ...
            <div class="d-flex flex-column mb-8">
                <div class="mb-8 fv-row">
                    ...
                    <div wire:ignore class="position-relative d-flex align-items-center">
                        ...
                        <input wire:model="deadline" value="<?php echo e($deadline); ?>" type="text" class="form-control form-control-solid"
...
<?php /**PATH /home/asougrou/core/resources/views/livewire/manage-projects/edit-project-component.blade.php ENDPATH**/ ?>