<div class="card mb-5 mb-xl-10 ">
    ...
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bold fs-3 mb-1">مدیریت چت ها</span>
        </h3>
        <div class="card-toolbar " data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
            ...
            <div id="kt_header_search" class="header-search d-flex align-items-center w-lg-250px me-3" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter" data-kt-search-layout="menu" data-kt-search-responsive="lg" data-kt-menu-trigger="auto" data-kt-menu-permanent="true" data-kt-menu-placement="bottom-end">
                ...
                <div wire:ignore data-kt-search-element="form" class="searching-div d-block d-lg-block w-100 position-relative mb-2 mb-lg-0" autocomplete="true">
                    ...
                    <!--end::Icon-->
                    <!--begin::Input-->
                    <input type="text" id="searching" class="searching-input form-control bg-transparent ps-13 fs-7 " style="border-radius:0.3rem;padding-top: calc(0.55rem + 1px);padding-top: calc(0.55rem + 1px);" name="search" placeholder="جستجوی کاربر" data-kt-search-element="input" />
                    <!--end::Input-->
                    <!--begin::Spinner-->
            ...
            <?php else: ?>
                ...
                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                    ...
                    <tr class="fw-bold text-muted">
                        ...
                        <th class="min-w-150px">دپارتمان</th>
                        ...
                        <tr>
                                    ...
                                    <div class="d-flex justify-content-start flex-column">
                                        <a href="#">
                                            <p class="text-dark fw-bold text-hover-primary fs-6">
                                                <?php echo e($item->department=='technical' ? 'بخش فنی':'مدیریت مجموعه'); ?>
                            ...
                            <td>
                                <div class="d-flex justify-content-end flex-shrink-0">
                                    <a href="chat/details/<?php echo e($item->id); ?>" class="cursor-pointer btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                    <!--[if BLOCK]><![endif]--><?php if($item->hasUnread==1): ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/asougrou/core/resources/views/livewire/manage-chat/management-chat-list-component.blade.php ENDPATH**/ ?>