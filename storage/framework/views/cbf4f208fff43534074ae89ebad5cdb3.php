                        ...
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_new_task_scroll" data-kt-scroll="true"
                            ...
                            <div class="f-flex flex-column mb-10">
                                ...
                                <select id="selectedTaskStatus" class=" custom-select sources form-control "
                                    ...
                                    <option <?php if($selectedTaskStatus == "waiting"): ?> selected <?php endif; ?> value="waiting"
                                            class="select-modal">انجام نشده
                                    </option>
                                    <option <?php if($selectedTaskStatus == "progressing"): ?> selected
                                            <?php endif; ?> value="progressing" class="select-modal">در حال انجام
                                    </option>
                                    <option <?php if($selectedTaskStatus == "finished"): ?> selected <?php endif; ?> value="finished"
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div class="d-flex flex-column mb-10 fv-row">
                                    ...
                                    <label class="col-lg-8 col-form-label fw-semibold fs-6">
                                        <span class="">
                                           <?php echo e($finishedDate? 'تاریخ فعلی پایان کار: '.verta($finishedDate)->format('Y/m/d'): 'تاریخ پایان کار'); ?> 
                                        </span>
                                    </label>
                                    <!--end::Tags-->
                                    <div wire:ignore >
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\B\work\Asou\main asou react\asoon\resources\views/livewire/manage-task/change-task-status-component.blade.php ENDPATH**/ ?>