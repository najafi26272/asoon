...
<div wire:ignore.self class="modal fade" id="kt_modal_delete_report" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-450px">
        <!--begin::Modal content-->
        <div class="modal-content">
            <!--begin::Modal header-->
            <div class="modal-header" id="kt_modal_delete_report_header">
                <!--begin::Modal title-->
                <h2>حذف گزارش</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
...
<?php /**PATH D:\B\work\Asou\main asou react\asoon\resources\views/livewire/manage-reports/delete-report-component.blade.php ENDPATH**/ ?>