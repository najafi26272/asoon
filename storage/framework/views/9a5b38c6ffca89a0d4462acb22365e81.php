                ...
                <div class="row  mt-5 notice bg-light-primary rounded border-primary border border-dashed min-w-lg-600px p-6">
                    ...
                    <div class=" col-10 d-flex  mb-8 fv-row">
                        ...
                        <div class="form-check form-check-solid form-switch form-check-custom fv-row">
                            <input wire:model='status' class="form-check-input w-45px h-30px" type="checkbox" id="accept" <?php if($status != 'reject'): ?> checked="checked" <?php endif; ?>>
...
</div><?php /**PATH D:\B\work\Asou\main asou react\asoon\resources\views/livewire/manage-news/monitoring-news/edit-content-component.blade.php ENDPATH**/ ?>