...
<div wire:ignore.self class="modal fade" id="kt_modal_new_projectTask" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
                        ...
                        <div class="f-flex flex-column mb-8">
                            ...
                            <label class="required fs-6 fw-semibold mb-2">شخص مسئول </label>
                                ...
                                <option value=""> موردی انتخاب نشده است...</option>
                                    <option value="<?php echo e($project->user_id); ?>"> <?php echo e($project->user->name); ?> <?php echo e($project->user->family); ?></option>
...
<?php /**PATH D:\B\work\Asou\main asou react\asoon\resources\views/livewire/manage-projects/manage-tasks/create-task-component.blade.php ENDPATH**/ ?>