...
<div wire:ignore.self class="modal fade" id="kt_modal_delete_news" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-450px">
        <!--begin::Modal content-->
        <div class="modal-content">
            <!--begin::Modal header-->
            <div class="modal-header" id="kt_modal_delete_news_header">
                <!--begin::Modal title-->
                <h2>حذف خبر</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
...
<?php /**PATH D:\B\work\Asou\main asou react\asoon\resources\views/livewire/manage-news/monitoring-news/delete-news-component.blade.php ENDPATH**/ ?>