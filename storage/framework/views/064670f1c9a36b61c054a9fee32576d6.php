...
<div class="card mb-5 mb-xl-10">
    ...
    <div class="card-header border-0 pt-5">
        ...
        <div class="card-toolbar " data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
            ...
            <!--[if BLOCK]><![endif]--><?php if(Auth::user()->level == 'admin'): ?>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="d-flex justify-content-start flex-column">
                                    <a href="/admin/meetings/details/<?php echo e($item->id); ?>">
...
<?php /**PATH D:\B\work\Asou\main asou react\asoon\resources\views/livewire/manage-jalase/jalase-list-component.blade.php ENDPATH**/ ?>