                    ...
                    <div class="col-lg-8">
                        ...
                        <div wire:ignore.selfe class="image-input image-input-outline" data-kt-image-input="true"
                            ...
                            <div class="image-input-wrapper w-125px h-125px"
                                 style="background-image: url( <?php if($image): ?> <?php echo e(asset("storage/images/users/avatar")); ?>/<?php echo e($image); ?> <?php else: ?> <?php echo e(asset("assets/media/svg/avatars/blank.svg")); ?> <?php endif; ?>       )"></div>
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row">
                            <!--begin::Col-->
                            <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                <input disabled value="<?php echo e($nationalCode); ?>"
                                       class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                       placeholder="کدملی">
...
<?php /**PATH D:\B\work\Asou\main asou react\asoon\resources\views/livewire/manage-user/edit-profile-component.blade.php ENDPATH**/ ?>