<div class="card mb-5 mb-xl-10">
    ...
    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
        ...
        <div class="card-title m-0">
            <h3 class="fw-bold m-0">کاربر جدید </h3>
        </div>
        <!--end::کارت title-->
    </div>
    <!--begin::کارت header-->
    ...
    <div id="kt_account_settings_profile_details" class="collapse show">
        <!--begin::Form-->
        <form wire:submit.prevent="submit" autocomplete="off" id="kt_account_profile_details_form"
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true"
                            ...
                            <div class="image-input-wrapper w-125px h-125px"
                                 style="background-image: url(<?php echo e(asset("assets/media/svg/avatars/blank.svg")); ?>)"></div>
                            ...
                            <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                                ...
                                <!--begin::Inputs-->
                                <input type="file" wire:model.debounce.1500="image" accept=".png, .jpg, .jpeg">
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['family'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row">
                            <!--begin::Col-->
                            <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                <input type="text" wire:model.debounce.1500="nationalCode"
                                       class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                       placeholder="کدملی">
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['nationalCode'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                <input type="text" wire:model="employeeCode"
                                       class="form-control form-control-lg form-control-solid"
                                       placeholder="کدکارمندی" autocomplete="off">
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['employeeCode'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="row mb-6">
                    <!--begin::Tags-->
                    <label class="required col-lg-4 col-form-label fw-semibold fs-6">رمز عبور</label>
                    <!--end::Tags-->
                    <!--begin::Col-->
                    <div class="col-lg-8">
                        <!--begin::Row-->
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['rePassword'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="row mb-6">
                    <!--begin::Tags-->
                    <label class="col-lg-4 col-form-label required fw-semibold fs-6">نوع قرارداد</label>
                    <!--end::Tags-->
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <!--begin::تنظیمات-->
                        <div class="d-flex align-items-center mt-3">
                            ...
                            <label class="form-check form-check-custom form-check-inline form-check-solid me-5">
                                <input wire:model="contractType.rasmi" class="form-check-input"
                                       type="checkbox">
                                <span class="fw-semibold ps-2 fs-6">رسمی</span>
                            </label>
                            <!--end::Option-->
                            <!--begin::Option-->
                            <label class="form-check form-check-custom form-check-inline form-check-solid">
                                <input wire:model="contractType.gharardadi" class="form-check-input"
                                       type="checkbox">
                                <span class="fw-semibold ps-2 fs-6">قراردادی</span>
                            </label>
                            <!--end::Option-->
                        </div>
                        <!--end::تنظیمات-->
                ...
                <div class="row mb-0">
                    <!--begin::Tags-->
                    <label class="col-lg-4 col-form-label fw-semibold fs-6">وضعیت حساب کاربری</label>
                    <!--begin::Tags-->
                    <!--begin::Tags-->
                    <div class="col-lg-8 d-flex align-items-center">
                        <div class="form-check form-check-solid form-switch form-check-custom fv-row">
                            <input wire:model="status" class="form-check-input w-45px h-30px"
                                   type="checkbox">
...
<?php /**PATH E:\Laravel\asuojalasat\resources\views/livewire/manage-user/create-user-component.blade.php ENDPATH**/ ?>