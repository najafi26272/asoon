<div wire:ignore.self class="modal fade" id="kt_modal_title_details" tabindex="-1" aria-hidden="true">
    <!-- Modal Dialog -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-check form-check-solid form-switch form-check-success fv-row">
                                            ...
                                            <label for="accept"><?php echo e($need_cover==1 ? 'دارد' : 'ندارد'); ?></label>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
...
</div><?php /**PATH D:\B\work\Asou\main asou react\asoon\resources\views/livewire/manage-news/news-title/title-details-component.blade.php ENDPATH**/ ?>