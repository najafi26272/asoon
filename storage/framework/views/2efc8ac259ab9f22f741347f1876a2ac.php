...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                <input type="text" wire:model.debounce.1500="employeeCode"
                                       class="form-control form-control-lg form-control-solid"
...
<?php /**PATH E:\Laravel\asuojalasat\resources\views/livewire/manage-user/edit-user-component.blade.php ENDPATH**/ ?>