<div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
    ...
    <form class="form w-100" wire:submit.prevent="submit" method="POST" >
        ...
        <div class="fv-row mb-8">
            <!--begin::ایمیل-->
            <input type="text" placeholder="ایمیل" wire:model="data.username" autocomplete="off" class="form-control bg-transparent" />
            <!--end::ایمیل-->
...
<?php /**PATH E:\Laravel\asuojalasat\resources\views/livewire/manage-login/login-component.blade.php ENDPATH**/ ?>