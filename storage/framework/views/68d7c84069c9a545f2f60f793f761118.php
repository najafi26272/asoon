...
<div wire:ignore.self class="modal fade" id="kt_modal_edit_task" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
                        ...
                        <div class="d-flex flex-column mb-8">
                            <div class="mb-8 fv-row">
                                <label class="fs-6 fw-semibold mb-2">
                                    <?php echo e($currentEndDate ? 'تاریخ سررسید فعلی: '.verta($currentEndDate)->format('Y/m/j H:i') : 'تاریخ سررسید'); ?>
                                ...
                                <div wire:ignore class="position-relative d-flex align-items-center">
                                    ...
                                    <input  wire:model="selectedDate" value="<?php echo e($selectedDate); ?>"  type="text" class="form-control form-control-solid" placeholder="تاریخ سررسید جدید" id="flatpickr-edit-task">
                                    <!--end::تاریخpicker-->
                                </div>
                                <!--end::Input-->
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\B\work\Asou\main asou react\asoon\resources\views/livewire/manage-task/edit-task-component.blade.php ENDPATH**/ ?>