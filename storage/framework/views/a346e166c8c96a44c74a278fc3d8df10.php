            ...
            <div class="col-lg-6 col-xxl-6">
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body p-9 d-flex justify-content-between">
                        ...
                        <div class="">
                            <img src="<?php echo e(asset("assets/media/icons/present.png")); ?>" class="img-icon">
                        </div>
                    </div>
                    <!--end::کارت body-->
                </div>
            ...
            <div class="col-lg-6 col-xxl-6">
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body p-9 d-flex justify-content-between">
                        ...
                        <div class="">
                            <img src="<?php echo e(asset("assets/media/icons/absent.png")); ?>" class="img-icon">
                        </div>
                    </div>
                    <!--end::کارت body-->
                </div>
...
<script src="<?php echo e(asset("assets/js/custom/utilities/modals/create-user.js")); ?>"></script>
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Laravel\asuojalasat\resources\views/admin/pages/create-user.blade.php ENDPATH**/ ?>