                ...
                <div class="card  p-lg-17 ">
                    <div class="card-header border-1 pt-5 m-auto">
                         ...
                         <h3 class="fs-2hx text-dark mb-6 text-center">
                              <i class="fa fa-phone fs-3tx text-primary"></i>
                          تماس با ما 
                    </h3>
                    </div>
                    ...
                    <div class="card-body">
                       <!--begin::تماس با ما-->
							<div class="card">
								<!--begin::Body-->
								<div class="card-body p-lg-17 pb-lg-0">
									<!--begin::Row-->
									<div class="row mb-3">
										<!--begin::Col-->
										<div class="col-md-6 pe-lg-10">
											...
											<form action="#" class="form mb-15" method="post" id="kt_contact_form">
												<h1 class="fw-bold text-dark mb-9">ارسال ایمیل برای ما</h1>
												<!--begin::Input group-->
												<div class="row mb-5">
													<!--begin::Col-->
													<div class="col-md-6 fv-row">
														<!--begin::Tags-->
														<label class="fs-5 fw-semibold mb-2">نام</label>
														<!--end::Tags-->
														<!--begin::Input-->
													...
													<div class="col-md-6 fv-row">
														<!--end::Tags-->
														<label class="fs-5 fw-semibold mb-2">ایمیل</label>
														<!--end::Tags-->
														<!--end::Input-->
												...
												<div class="d-flex flex-column mb-5 fv-row">
													<!--begin::Tags-->
													<label class="fs-5 fw-semibold mb-2">موضوع</label>
													<!--end::Tags-->
													<!--begin::Input-->
												...
												<div class="d-flex flex-column mb-10 fv-row">
													<label class="fs-6 fw-semibold mb-2">پیام</label>
												...
												<button type="submit" class="btn btn-primary" id="kt_contact_submit_button">
													...
													<span class="indicator-label">ارسال بازخورد</span>
													<!--end::Indicatیا label-->
										...
										<div class="col-md-6 ps-lg-10">
											...
											<div class="bg-light card-rounded d-flex flex-column flex-center flex-center p-10 h-100 ">
												...
												<!--end::Icon-->
												<!--begin::Subtitle-->
												<h1 class="text-dark fw-bold my-5">بیا صحبت کنیم</h1>
												<!--end::Subtitle-->
												<!--begin::شماره کارت-->
											...
											<div class="text-center bg-light card-rounded d-flex flex-column flex-center p-10 h-100">
												...
												<!--end::Icon-->
												<!--begin::Subtitle-->
												<h1 class="text-dark fw-bold my-5">دفتر مرکزی ما</h1>
												<!--end::Subtitle-->
												<!--begin::توضیحات-->
												<div class="text-gray-700 fs-3 fw-semibold">چرچیل لان 16 II ، 1052 CD ، آمستردام</div>
												<!--end::توضیحات-->
											</div>
											<!--end::آدرس-->
										    </div>
...
<?php /**PATH /home/asougrou/core/resources/views/admin/pages/forms/contact.blade.php ENDPATH**/ ?>