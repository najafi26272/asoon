<div class="card mb-5 mb-xl-10">
    ...
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bold fs-3 mb-1">وظایف پروژه <?php echo e($project->title); ?> </span>
        </h3>
        <!--[if BLOCK]><![endif]--><?php if(\Illuminate\Support\Facades\Auth::user()->accesses->project_access): ?>
            <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                ...
                <a href="#" class="btn btn-sm btn-light btn-active-primary" data-bs-toggle="modal"
                   data-bs-target="#kt_modal_new_projectTask">
...
<?php /**PATH D:\B\work\Asou\main asou react\asoon\resources\views/livewire/manage-projects/manage-tasks/task-list-component.blade.php ENDPATH**/ ?>