...
<div wire:ignore.self class="modal fade" id="kt_modal_edit_projectTask" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
                        ...
                        <div class="f-flex flex-column mb-8">
                            <label class="required fs-6 fw-semibold mb-2">شخص مسئول </label>
                              <select id="selectedUser" class="form-select form-select-solid" data-control="select2" wire:model="selectedUser" data-hide-search="true" data-placeholder="یک مورد را انتخاب کنید" name="selectedUser">
                                 <option <?php if($selectedUser == $managerId): ?> selected <?php endif; ?> value="<?php echo e($managerId); ?>"> <?php echo e($managerName); ?> <?php echo e($managerFamily); ?></option>
...
<?php /**PATH D:\B\work\Asou\main asou react\asoon\resources\views/livewire/manage-projects/manage-tasks/edit-task-component.blade.php ENDPATH**/ ?>