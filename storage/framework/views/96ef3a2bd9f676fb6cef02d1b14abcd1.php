...
<div wire:ignore.self class="modal fade" id="kt_modal_delete_projectTask" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-450px">
        <!--begin::Modal content-->
        <div class="modal-content">
            <!--begin::Modal header-->
            <div class="modal-header" id="kt_modal_delete_mosavabe_header">
                <!--begin::Modal title-->
                <h2>حذف وظیفه</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
...
<?php /**PATH D:\B\work\Asou\main asou react\asoon\resources\views/livewire/manage-projects/manage-tasks/delete-task-component.blade.php ENDPATH**/ ?>