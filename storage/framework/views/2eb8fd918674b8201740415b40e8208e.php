...
<!--begin::صندوق پیام اپلیکیشن - ارسال -->
								...
								<div class="flex-lg-row-fluid ms-lg-7 ms-xl-10">
									...
									<div class="card">
										<div class="card-header d-flex align-items-center justify-content-between py-3">
											<h2 class="card-title m-0">ارسال پیام</h2>
											<!--begin::Toggle-->
											...
											<form id="kt_inbox_compose_form">
												...
												<div class="d-block">
													...
													<div class="border-bottom">
														<input class="form-control form-control-transparent border-0 px-8 min-h-45px" name="compose_subject" placeholder="موضوع" />
													</div>
													<!--end::موضوع-->
													<!--begin::Message-->
													<div id="kt_inbox_form_editیا" class="bg-transparent border-0 h-350px px-3"></div>
													<!--end::Message-->
													<!--begin::Attachments-->
													...
													<div class="d-flex align-items-center me-3">
														...
														<div class="btn-group me-4">
															...
															<span class="btn btn-primary btn-icon fs-bold w-30px pe-0" role="button">
																<span class="lh-0" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
							...
							<!--end::صندوق پیام اپلیکیشن - ارسال -->
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/asougrou/core/resources/views/admin/pages/inbox/compose.blade.php ENDPATH**/ ?>