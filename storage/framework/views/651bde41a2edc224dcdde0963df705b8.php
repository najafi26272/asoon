...
?>
            <div class="d-flex align-items-center ms-3 ms-lg-4">
                ...
                <div class="btn btn-icon btn-color-gray-700 btn-active-color-primary btn-outline w-40px h-40px position-relative" id="kt_drawer_chat_toggle">
                    ...
                    <!--begin::Bullet-->
                    <?php if($chatCount > 0): ?><span class="bullet bullet-dot bg-success h-6px w-6px position-absolute translate-middle top-0 start-50 animation-blink"></span><?php endif; ?>
                    <!--end::Bullet-->
                </div>
                <!--end::کشو wrapper-->
            </div>
...
<?php /**PATH D:\B\work\Asou\main asou react\asoon\resources\views/admin/parts/header.blade.php ENDPATH**/ ?>