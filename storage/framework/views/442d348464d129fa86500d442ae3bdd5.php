                        ...
                        <div class="m-0 ">
                            ...
                            <div class="d-flex align-items-center collapsible py-3 toggle mb-0" data-bs-toggle="collapse" data-bs-target="#item.<?php echo e($i); ?>">
                                ...
                                <h4 class="text-gray-700 fw-bold cursor-pointer mb-0">   
                                    <?php echo e(verta($value->updated_at)->format('Y/m/d') . ' : ' . Str::limit(strip_tags(html_entity_decode($value->edited_content)), 20, '...')); ?>
...
</div><?php /**PATH D:\B\work\Asou\main asou react\asoon\resources\views/livewire/manage-news/monitoring-news/review-history-component.blade.php ENDPATH**/ ?>