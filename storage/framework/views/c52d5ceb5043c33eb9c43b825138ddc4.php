...
[$__name, $__params] = $__split('manage-review-news.review-news-list-component', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-892598842-0', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\B\work\Asou\main asou react\asoon\resources\views/admin/pages/news/review/reviewNews-list.blade.php ENDPATH**/ ?>