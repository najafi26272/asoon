                        ...
                        <div class="d-flex flex-column mb-8">
                            <div class="mb-8 fv-row">
                                <label class="fs-6 fw-semibold mb-2">
                                    {{$currentEndDate ? 'تاریخ سررسید فعلی: '.verta($currentEndDate)->format('Y/m/j H:i') : 'تاریخ سررسید'}}
                                ...
                                <div wire:ignore class="position-relative d-flex align-items-center">
                                    ...
                                    <input  wire:model="selectedDate" value="{{$selectedDate}}"  type="text" class="form-control form-control-solid" placeholder="تاریخ سررسید جدید" id="flatpickr-edit-task">
                                    <!--end::تاریخpicker-->
                                </div>
                                <!--end::Input-->
                                @error('selectedDate')
