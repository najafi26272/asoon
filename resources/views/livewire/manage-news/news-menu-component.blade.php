            ...
            <div class="card-header border-0 pt-9 m-auto">
                ...
                <div class="card-title m-0">
                    ...
                    <div class="symbol symbol-50px w-50px bg-light">
                        <img src="{{asset("assets/img/rasad.png")}}"  alt="image" class="p-3">
                    </div>
                    <!--end::Avatar-->
                </div>
                <!--end::Car Title-->
            ...
            <div class="card-body p-9">
                ...
                <div class="d-flex flex-wrap mb-5 justify-center">
                    ...
                    <div class="border border-gray-300 border-dashed rounded min-w-120px py-3 px-4 me-7 mb-3">
                        <div class="fs-6 text-gray-800 fw-bold">{{$waitingForApproveMonitoringNewsCount}}</div>
                        <div class="fw-semibold text-gray-400">درانتظار تایید</div>
                    </div>
                    <!--end::Due-->
                    <!--begin::Due-->
                    <div class="border border-gray-300 border-dashed rounded min-w-120px py-3 px-4 me-7 mb-3">
                        <div class="fs-6 text-gray-800 fw-bold">{{$approvedMonitoringNewsCount}}</div>
                    ...
                    <div class="border border-gray-300 border-dashed rounded min-w-120px py-3 px-4 mb-3">
                        <div class="fs-6 text-gray-800 fw-bold">{{$rejectedMonitoringNewsCount}}</div>
                ...
                <!--begin::پردازش-->
                <div class=" mb-5" >
                    <a target="_blank" href="{{route('monitoringNews')}}" class="btn btn-primary  w-full" style="width: 100%">مشاهده</a>
                </div>
                <!--end::پردازش-->
            </div>
            <!--end:: کارت body-->
            ...
            <div class="card-body p-9">
                ...
                <div class="d-flex flex-wrap mb-5 justify-center">
                    ...
                    <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-7 mb-3">
                        <div class="fs-6 text-gray-800 fw-bold">{{$waitingForAddInfoNewsCount}}</div>
                        <div class="fw-semibold text-gray-400">در انتظار افزودن اطلاعات</div>
                    </div>
                    <!--end::Due-->
                    <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-7 mb-3">
                        <div class="fs-6 text-gray-800 fw-bold">{{$addedInfoNewsCount}}</div>
                ...
                <!--begin::پردازش-->
                <div class=" mb-5" >
                    <a target="_blank" href="{{route('addInfoNews')}}" class="btn btn-primary  w-full" style="width: 100%">مشاهده</a>
                </div>
                <!--end::پردازش-->
            </div>
            <!--begin:: کارت body-->
    ...
    <div class="col-md-6 col-xl-4">
        ...
        <div  class="card border-hover-primary text-center">
            ...
            <div class="card-body p-9">
                ...
                <div class="d-flex flex-wrap mb-5 justify-center">
                    <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-7 mb-3">
                        <div class="fs-6 text-gray-800 fw-bold">{{$approvedReviewNewsCount}}</div>
                        <div class="fw-semibold text-gray-400">تاییدشده</div>
                    </div>
                    <div class="border border-danger border-dashed rounded min-w-125px py-3 px-4 mb-3">
                        <div class="fs-6 text-gray-800 fw-bold">{{$waitingForAssignReviewNewsCount}}</div>
                        <div class="fw-semibold text-gray-400">در انتظار ارجاع به بازنویس</div>
                    </div>
                    <div class="border border-danger border-dashed rounded min-w-125px py-3 px-4 mb-3">
                        <div class="fs-6 text-gray-800 fw-bold">{{$waitingForReviewNewsCount}}</div>
                        <div class="fw-semibold text-gray-400">در انتظار بازنویسی</div>
                    </div>
                    <div class="border border-danger border-dashed rounded min-w-125px py-3 px-4 mb-3">
                        <div class="fs-6 text-gray-800 fw-bold">{{$waitingForCheckingReviewNewsCount}}</div>
                        <div class="fw-semibold text-gray-400">در انتظار بررسی بازنویسی</div>
                    </div>
                    <div class="border border-danger border-dashed rounded min-w-125px py-3 px-4 mb-3">
                        <div class="fs-6 text-gray-800 fw-bold">{{$rejectedReviewNewsCount}}</div>
                ...
                <!--begin::پردازش-->
                <div class=" mb-5" >
                    <a target="_blank" href="{{route('reviewNews')}}" class="btn btn-primary  w-full" style="width: 100%">مشاهده</a>
                </div>
                <!--end::پردازش-->
            </div>
            <!--end:: کارت body-->
        ...
        <div  class="card border-hover-primary text-center">
            ...
            <div class="card-body p-9">
                ...
                <div class="d-flex flex-wrap mb-5 justify-center">
                    <!--begin::Due-->
                    <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-7 mb-3">
                        <div class="fs-6 text-gray-800 fw-bold">{{$publishedCount}}</div>
                        <div class="fw-semibold text-gray-400">منتشرشده</div>
                    </div>
                    <!--end::Due-->
                    <!--begin::بودجه-->
                    <div class="border border-danger border-dashed rounded min-w-125px py-3 px-4 mb-3">
                        <div class="fs-6 text-gray-800 fw-bold">{{$waitingForPublishedCount}}</div>
                        <div class="fw-semibold text-gray-400">درانتظار انتشار</div>
                    </div>
                    <!--end::بودجه-->
                     <!--begin::Due-->
                     <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-7 mb-3">
                        <div class="fs-6 text-gray-800 fw-bold">{{$notPublishedCount}}</div>
                ...
                <!--begin::پردازش-->
                <div class=" mb-5" >
                    <a target="_blank" href="{{route('finalNews')}}" class="btn btn-primary  w-full" style="width: 100%">مشاهده</a>
                </div>
                <!--end::پردازش-->
            </div>
            <!--end:: کارت body-->
        ...
        <div  class="card border-hover-primary text-center">
            ...
            <div class="card-body p-9">
                ...
                <div class="d-flex flex-wrap mb-5 justify-center">
                    <!--begin::Due-->
                    <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-7 mb-3">
                        <div class="fs-6 text-gray-800 fw-bold">{{$waitingForApproveMyMonitoringNewsCount}}</div>
                        <div class="fw-semibold text-gray-400">درانتظار تایید</div>
                    </div>
                    <!--end::Due-->
                    <!--begin::بودجه-->
                    <div class="border border-danger border-dashed rounded min-w-125px py-3 px-4 mb-3">
                        <div class="fs-6 text-gray-800 fw-bold">{{$approvedMyMonitoringNewsCount}}</div>
                        <div class="fw-semibold text-gray-400">تایید شده</div>
                    </div>
                    <!--end::بودجه-->
                    <!--begin::بودجه-->
                    <div class="border border-danger border-dashed rounded min-w-125px py-3 px-4 mb-3">
                        <div class="fs-6 text-gray-800 fw-bold">{{$rejectedMyMonitoringNewsCount}} </div>
                        <div class="fw-semibold text-gray-400">رد شده</div>
                    </div>
                    <!--end::بودجه-->
                </div>
                ...
                <!--begin::پردازش-->
                <div class=" mb-5" >
                    <a target="_blank" href="{{route('myMonitoringNews')}}" class="btn btn-primary  w-full" style="width: 100%">مشاهده</a>
                </div>
                <!--end::پردازش-->
            </div>
            <!--end:: کارت body-->
        ...
        <div  class="card border-hover-primary text-center">
            ...
            <div class="card-body p-9">
                ...
                <div class="d-flex flex-wrap mb-5 justify-center">
                    <!--begin::Due-->
                    <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-7 mb-3">
                        <div class="fs-6 text-gray-800 fw-bold">{{$waitingForMyTitrsCount}}</div>
                        <div class="fw-semibold text-gray-400">در انتظار تیتر</div>
                    </div>
                    <!--end::Due-->
                    <!--begin::بودجه-->
                    <div class="border border-danger border-dashed rounded min-w-125px py-3 px-4 mb-3">
                        <div class="fs-6 text-gray-800 fw-bold">{{$waitingForApproveMyTitrsCount}}</div>
                        <div class="fw-semibold text-gray-400">درانتظار بررسی تیتر</div>
                    </div>
                    <!--end::بودجه-->
                        <!--begin::Due-->
                        <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-7 mb-3">
                        <div class="fs-6 text-gray-800 fw-bold">{{$approvedMyTitrsCount}}</div>
                        <div class="fw-semibold text-gray-400">تاییدشده</div>
                    </div>
                    <!--end::Due-->
                    <!--begin::بودجه-->
                    <div class="border border-danger border-dashed rounded min-w-125px py-3 px-4 mb-3">
                        <div class="fs-6 text-gray-800 fw-bold">{{$rejectedMyTitrsCount}}</div>
                        <div class="fw-semibold text-gray-400">رد شده</div>
                    </div>
                    <!--end::بودجه-->
                </div>
                ...
                <!--begin::پردازش-->
                <div class=" mb-5" >
                    <a target="_blank" href="{{route('newsMyTitle')}}" class="btn btn-primary  w-full" style="width: 100%">مشاهده</a>
                </div>
                <!--end::پردازش-->
            </div>
            <!--end:: کارت body-->
    ...
    <div class="col-md-6 col-xl-4">
        ...
        <div  class="card border-hover-primary text-center">
            ...
            <div class="card-body p-9">
                ...
                <div class="d-flex flex-wrap mb-5 justify-center">
                    <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-7 mb-3">
                        <div class="fs-6 text-gray-800 fw-bold">{{$approvedMyReviewNewsCount}}</div>
                        <div class="fw-semibold text-gray-400">تاییدشده</div>
                    </div>
                    <div class="border border-danger border-dashed rounded min-w-125px py-3 px-4 mb-3">
                        <div class="fs-6 text-gray-800 fw-bold">{{$waitingForMyReviewNewsCount}}</div>
                        <div class="fw-semibold text-gray-400">در انتظار بازنویسی</div>
                    </div>
                    <div class="border border-danger border-dashed rounded min-w-125px py-3 px-4 mb-3">
                        <div class="fs-6 text-gray-800 fw-bold">{{$waitingForCheckingMyReviewNewsCount}}</div>
                        <div class="fw-semibold text-gray-400">در انتظار بررسی بازنویسی</div>
                    </div>
                    <div class="border border-danger border-dashed rounded min-w-125px py-3 px-4 mb-3">
                        <div class="fs-6 text-gray-800 fw-bold">{{$rejectedMyReviewNewsCount}}</div>
                ...
                <!--begin::پردازش-->
                <div class=" mb-5" >
                    <a target="_blank" href="{{route('myReviewNews')}}" class="btn btn-primary  w-full" style="width: 100%">مشاهده</a>
                </div>
                <!--end::پردازش-->
            </div>
            <!--end:: کارت body-->
