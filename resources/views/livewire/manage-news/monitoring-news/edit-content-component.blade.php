        ...
        <div class="modal-content">
            <form wire:submit.prevent="submit" class="form" method="POST" id="kt_modal_new_review_form">
                ...
                <div class="modal-body py-10 px-lg-17">
                    <input type="text" value="{{ $edited_content }}" id="current_edited_content" style="display:none;">
    ...
    <script>
       document.addEventListener('DOMContentLoaded', function() {
            ...
            window.addEventListener('open-edit-modal', function() {
                setTimeout(function() {
                    var currentValue = @this.edited_content; // Access the Livewire property directly
            ...
            document.getElementById('submit-btn').addEventListener('click', function (e) {
                ...
                @this.set('edited_content', content); // Update Livewire property
            });
        });
