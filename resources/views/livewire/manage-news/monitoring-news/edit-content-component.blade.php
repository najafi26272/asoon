                ...
                <div class="  mt-5 notice  rounded border-primary border border-dashed min-w-lg-600px p-6">
                    ...
                    <div class="row">
                        <div class="col-12 mb-4 fv-row">
                            <input type="text" wire:model='description' value="{{$description}}" class="form-control form-control-sm min-w-100px mt-1" id="reasonInput" placeholder="دلیل  ویرایش مجدد" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-2 d-flex flex-column justify-content-center mb-4 fv-row">
