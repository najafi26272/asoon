                ...
                <div class="row  mt-5 notice bg-light-primary rounded border-primary border border-dashed min-w-lg-600px p-6">
                    ...
                    <div class=" col-10 d-flex  mb-8 fv-row">
                        ...
                        <div class="form-check form-check-solid form-switch form-check-custom fv-row">
                            <input wire:model='status' class="form-check-input w-45px h-30px" type="checkbox" id="accept" @if($status != 'reject') checked="checked" @endif>
                            <label class="form-check-label" for="allowmarketing">تایید</label>
                        </div>
                        
                    </div>
                    <div class="col-12 mb-8 fv-row">
                        <input type="text" wire:model='description' value="{{$description}}" class="form-control form-control-sm  min-w-100px mt-1 " id="reasonInput" placeholder="دلیل رد شدن"/>
                    </div>
