...
{{--<div>--}}
{{--    <form wire:submit.prevent="submit" method="POST" id="create-post" enctype="multipart/form-data" autocomplete="off">--}}
{{--        <div class="row">--}}
{{--            <div class="col-md-8">--}}
{{--                <div class="card p-3">--}}
{{--                    <div>--}}
{{--                        <label for="mainTitr" class="form-label">تیتر اصلی</label>--}}
{{--                        <input id="mainTitr" type="text" class="form-control"--}}
{{--                               wire:model.debounce.1500="data.title"--}}
{{--                               placeholder="تیتر اصلی را وارد کنید">--}}
{{--                        @error('data.title')--}}
{{--                        <div id="defaultFormControlHelp" class="form-text text-danger">--}}
...
{{--                    </div>--}}
{{--                    <div class="m-t-15">--}}
{{--                        <label for="rootitir" class="form-label">رو تیتر</label>--}}
{{--                        <input id="rootitir" type="text" class="form-control"--}}
{{--                               wire:model.debounce.1500="data.topTitle"--}}
{{--                               placeholder="رو تیتر را وارد کنید">--}}
{{--                        @error('data.topTitle')--}}
{{--                        <div id="defaultFormControlHelp" class="form-text text-danger">--}}
...
{{--                    <div wire:ignore class="m-t-15">--}}
{{--                        <label for="flatpickr-datetime" class="form-label">تاریخ انتشار</label>--}}
{{--                        <input wire:model="data.publishedDate" type="text" class="form-control"--}}
{{--                               placeholder="YYYY/MM/DD - HH:MM"--}}
{{--                               id="flatpickr-datetime">--}}
{{--                    </div>--}}

{{--                    <div class="mb-3 m-t-15">--}}
{{--                        <label for="formFile" class="form-label">تصویر نمایه</label>--}}
{{--                        <br>--}}
{{--                        <input type="file" wire:model.debounce.1500="data.image" id="img" style="display:none;"/>--}}
{{--                        <label for="img" class="choose-image-btn cursor-pointer">انتخاب عکس</label>--}}
{{--                        <span>--}}
{{--                           @if($data['image'])--}}
{{--                                {{$data['image']->getOriginalName()}}--}}
{{--                            @else--}}
{{--                                فایل عکسی انتخاب نشده است.--}}
{{--                            @endif--}}
{{--                        </span>--}}
...
{{--                        @enderror--}}
{{--                        @if($data['image'])--}}
{{--                            <img width="100" class="rounded" src="{{$data['image']->temporaryUrl()}}">--}}
{{--                        @else--}}
{{--                            <img width="100" class="rounded"--}}
{{--                                 src="{{asset("assets/admin/img/no-picture-available.jpg")}}">--}}
{{--                        @endif--}}
{{--                    </div>--}}
{{--                    <div class="mb-3">--}}
{{--                        <label for="formFile" class="form-label">عکس گوشه لید</label>--}}
{{--                        <br>--}}
{{--                        <input type="file" wire:model.debounce.1500="data.leadImage" id="img2" style="display:none;"/>--}}
{{--                        <label for="img2" class="choose-image-btn cursor-pointer">انتخاب عکس</label>--}}
{{--                        <span>--}}
{{--                            @if($data['leadImage'])--}}
{{--                                {{$data['leadImage']->getOriginalName()}}--}}
{{--                            @else--}}
{{--                                فایل عکسی انتخاب نشده است.--}}
{{--                            @endif--}}
{{--                        </span>--}}
...
{{--                        @enderror--}}
{{--                        @if($data['leadImage'])--}}
{{--                            <img width="100" class="rounded" src="{{$data['leadImage']->temporaryUrl()}}">--}}
{{--                        @else--}}
{{--                            <img width="100" class="rounded"--}}
{{--                                 src="{{asset("assets/admin/img/no-picture-available.jpg")}}">--}}
{{--                        @endif--}}
...
{{--                                    @if($status['id'] == 2 &&  !$publishAccess)--}}
{{--                                    @else--}}
{{--                                        <option value="{{$status['id']}}" @if($status['id'] == 3)selected @endif>{{$status['title']}}</option>--}}
{{--                                    @endif--}}
{{--                                @endforeach--}}
{{--                            </select>--}}
{{--                        </div>--}}
...
{{--                                @if(in_array($service['id'] ,$serviceAccess ))--}}
