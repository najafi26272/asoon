        ...
        <div class="card card-xl-stretch mb-xl-10 theme-dark-bg-body" style="background-color: #F7D9E3">
            ...
            <div class="card-body d-flex flex-column">
                ...
                <div class="pt-5">
                    ...
                    <!--end::Symbol-->
                    <!--begin::شماره کارت-->
                    <span class="text-dark fw-bold fs-3x me-2 lh-0">{{$jalaseCount}}</span>
                    <!--end::شماره کارت-->
                    <!--begin::Text-->
        ...
        <div class="card card-xxl-stretch mb-xl-10 theme-dark-bg-body" style="background-color: #CBF0F4">
            ...
            <div class="card-body d-flex flex-column">
                ...
                <div class="pt-5">
                    <span class="text-dark fw-bold fs-2x lh-0">تعداد</span>
                    <!--begin::شماره کارت-->
                    <span class="text-dark fw-bold fs-3x me-2 lh-0">{{$projectCount}}</span>
                    <!--end::شماره کارت-->
                    <!--begin::Text-->
                ...
                <div class="row g-0">
                    ...
                    <div class="col-6">
                        <div class="d-flex align-items-center mb-9 me-2">
                            ...
                            <!--begin::Title-->
                            <div>
                                <div class="fs-5 text-dark fw-bold lh-1">{{$tasksCount}}</div>
                    ...
                    <div class="col-6">
                        <div class="d-flex align-items-center mb-9 ms-2">
                            ...
                            <!--begin::Title-->
                            <div>
                                <div class="fs-5 text-dark fw-bold lh-1">{{$finishedTasksCount}}</div>
                    ...
                    <div class="col-6">
                        <div class="d-flex align-items-center me-2">
                            ...
                            <!--begin::Title-->
                            <div>
                                <div class="fs-5 text-dark fw-bold lh-1">{{$progressingTasksCount}}</div>
                    ...
                    <div class="col-6">
                        <div class="d-flex align-items-center ms-2">
                            ...
                            <!--begin::Title-->
                            <div>
                                <div class="fs-5 text-dark fw-bold lh-1">{{$waitungTasksCount}}</div>
