                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="d-flex justify-content-start flex-column">
                                    <a href="/admin/meetings/details/{{$item->id}}">
                                    ...
                                    <span class="text-muted fw-semibold text-muted d-block fs-7">
                                        ...
                                        @foreach($item->categories as $cat)
                                            {{$cat->title}}
                                            @php($i++)
                                            @if($i < count($item->categories))، @endif
                                        @endforeach
                                    </span>
                                </div>
                            </div>
                        ...
                        <td>
                            <p class="text-dark fw-bold text-hover-primary d-block fs-6">
                                {{verta($item->date)->format('Y/m/d')}}
                            </p>
                            <span class="text-muted fw-semibold text-muted d-block fs-7">
                                {{verta($item->date)->format('H:i')}}
                            </span>
                        </td>
                        <td class="text-end">
                        ...
                        <td>
                            <div class="d-flex justify-content-end flex-shrink-0">
                                <a href="/admin/mosavabat/{{$item->id}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
...
{{--                                    </i>--}}
                                ...
                                @if(\Illuminate\Support\Facades\Auth::user()->accesses->meetings_access)
                                <a href="meetings/edit/{{$item->id}}" class="cursor-pointer btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
