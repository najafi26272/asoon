                        ...
                        <tr>
                                    ...
                                    <div class="d-flex justify-content-start flex-column">
                                        <a href="#">
                                            <p class="text-dark fw-bold text-hover-primary fs-6">
                                                {{$item->department=='technical' ? 'بخش فنی':'مدیریت مجموعه'}}
                                            </p>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <td>
                                <div class="d-flex justify-content-end flex-shrink-0">
                                    <a href="chat/details/{{$item->id}}" class="cursor-pointer btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                    @if($item->hasUnread==1)
