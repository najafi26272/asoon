                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="d-flex justify-content-start flex-column">
                                        <a href="#">
                                            <p class="text-dark fw-bold text-hover-primary fs-6"> {{$item->title}}</p>
                                        </a>
                            ...
                            <td>
                                <p class="text-dark fw-bold text-hover-primary d-block fs-6">
                                    {{verta($item->start_date)->format('Y/m/d')}}
                                </p>
                            </td>
                            <td class="text-end">
                                <div class="d-flex flex-column w-100 me-2">
                                    ...
                                    <div class="d-flex flex-stack mb-2">
                                        <span class="text-muted me-2 fs-7 fw-bold">{{round($item->percent)}}%</span>
                                    </div>
                                    <div class="progress h-6px w-100">
                                        <div class="progress-bar @if($item->percent > 1 && $item->percent < 40) bg-warning @elseif($item->percent > 39 && $item->percent < 80) bg-primary @elseif($item->percent > 79 && $item->percent < 101)  bg-success @endif " role="progressbar" style="width:{{$item->percent}}%"
                            ...
                            <td>
                                <div class="d-flex justify-content-end flex-shrink-0">
                                     <a href="projects/chats/{{$item->id}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 cursor-pointer">
                                    ...
                                    <a href="projects/tasks/{{$item->id}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 cursor-pointer">
                                    ...
                                    @if(\Illuminate\Support\Facades\Auth::user()->accesses->project_access)
                                    <a href="projects/edit/{{$item->id}}" class="cursor-pointer btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 cursor-pointer">
                                    ...
                                    <a wire:click="delete({{$item->id}})" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm cursor-pointer">
