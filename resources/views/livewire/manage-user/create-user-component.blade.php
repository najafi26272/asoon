    ...
    <div id="kt_account_settings_profile_details" class="collapse show">
        ...
        <form wire:submit.prevent="submit" autocomplete="off" id="kt_account_profile_details_form"
            ...
            <div class="card-body border-top p-9">
                ...
                <div class="row mb-6">
                    <!--begin::Tags-->
                    <label class="col-lg-4 col-form-label fw-semibold fs-6">شهر و تاریخ تولد</label>
                    <!--end::Tags-->
                    <!--begin::Col-->
                    <div class="col-lg-8">
                        <!--begin::Row-->
                        <div class="row">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                <input type="text" wire:model.debounce.1500=""
                                       class="form-control form-control-lg form-control-solid"
                ...
                <div class="row mb-6">
                    <!--begin::Tags-->
                    <label class="col-lg-4 col-form-label fw-semibold fs-6">اطلاعات بانکی</label>
                    <!--end::Tags-->
                    <!--begin::Col-->
                    <div class="col-lg-8">
                        <!--begin::Row-->
