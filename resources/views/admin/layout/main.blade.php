    ...
    <div class="aside-menu flex-column-fluid ps-5 pe-3 mb-9" id="kt_aside_menu">
        ...
        <div class="w-100 hover-scroll-overlay-y d-flex pe-3" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention menu-active-bg fw-semibold my-auto"
                ...
                @if (\Illuminate\Support\Facades\Auth::user()->accesses?->user_access ?? false)
                ...
                @if ( \Illuminate\Support\Facades\Auth::user()->accesses?->management_news_access ?? false or \Illuminate\Support\Facades\Auth::user()->accesses?->personal_news_access ?? false  )
                    <!--begin:Menu item-->
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                        <span class="menu-link">
                            <span class="menu-icon">
                        ...
                        <div class="menu-sub menu-sub-accordion" kt-hidden-height="121" style="display: none; overflow: hidden;">
                            ...
                            @endif
                            @if (\Illuminate\Support\Facades\Auth::user()->accesses->personal_news_access)
                                <div class="menu-item">
                                    <!--begin:Menu link-->
