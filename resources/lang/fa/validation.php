...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'faDownloadLink'=> 'لینک دانلود',
        'enDownloadLink'=> 'لینک دانلود',
        'selected_category'=>"دسته بندی",
        'new_image'=> "تصویر جدید",
        'status_slider'=>"وضعیت اسلایدر",
        'banner_slider'=>"تصویر اسلایدر",
        'audio'=>"فایل صوتی",
        'price'=>"قیمت",
        'rate'=>"امتیاز",
        'etaaLink'=>"لینک",
        ...
        'data.username'=>"نام کاربری",
        'selectedService'=>"سرویس",
        'data.selectedService'=>"سرویس",
        'nationalCode'=>"کدملی",
        'selectedProvince'=>"استان",
        'telegram'=>"تلگرام",
        'instagram'=>"اینستاگرام",
        'selectedExpertises'=>"حوزه تخصصی",
        'selectedUsername'=>"نام کاربری",
        'selectedSubject'=>"موضوع",
        'data.selectedSubject'=>"موضوع",
        'selectedPart'=>"قسمت",
        'data.selectedPart'=>"قسمت",
        'selectedAuthor'=>"نویسنده",
        'data.selectedAuthor'=>"نویسنده",
        'topTitle'=>"روتیتر",
        'data.topTitle'=>"روتیتر",
        'data.title'=>"تیتر",
        'data.content'=>"محتوا",
        'data.image'=>"تصویر",
        'data.leadImage'=>"تصویر",
        'selectedServices'=>"سرویس",
        'newsCode'=>"کد خبر",
        'video'=>"ویدیو",
        'poster'=>"پوستر",
        ...
        'selectedDate'=>"تاریخ",
        'hazerin'=>"حاضرین",
        'selectedPartName'=>"نام بخش مربوطه",
        'selectedHazerin'=>"حاضرین",
        'selectedJalaseCategory'=>"دسته بندی",
        'reportFile'=>"فایل",
    ],
];
